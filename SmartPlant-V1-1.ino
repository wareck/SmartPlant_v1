...
const int ledPin = LEDPIN; // Digital output pin that the LED is attached to
const int pumpPin = PUMPPIN; // Digital output pin that the water pump is attached to
const int waterLevelPin = WATERLEVELPIN; // Analoge pin water level sensor is connected to
const int moistureSensorPin = MOISTURE ; // Digital input pin used to check the moisture level of the soil
...
void setup() {
  // put your setup code here, to run once:
    Serial.begin(9600);
    Serial.println("SmartPlant-V1.1:");  
...
void loop() {
  ...
  Serial.println("Teensy mode");
  #endif
  #if defined (ARDUINO)
  Serial.println("Arduino mode");
  #endif
  Serial.print("ledPin: ") ; Serial.println(ledPin);
  Serial.print("pumpPin: ") ; Serial.println(pumpPin);
  Serial.print("moistureSensorPin: ") ; Serial.println(moistureSensorPin);
  Serial.print("waterLevelPin: ") ; Serial.println(WATERLEVELPIN);  
  Serial.println("");
#endif
